...
app.post('/cadastroinsert', urlencodedParser, (req, res) => {
  ...
  sql = "INSERT INTO FichaCadastro (nomeCad, chamadoCad, docCad, rgCad,cpfCad,nascimentoCad,localCad ,abrigoCad,domPartCad,ruaVezCad,albVezCad,dompartvezCad,dompartQual,viveRuaCad,moraCidaCad,viveFamCad,parenteCad,attcomCad,atendLuCad,centroCad,centrorefCad,instacolhiCad,hospiCad,trabaCad,dinheiroCad,dinheiroCad2,dinheiroCad3,dinheiroCad4,dinheiroCad5,dinheiroCad6,dinheiroCad7,benefCad,qualBenefCad, marqViaCad, predioCad, parqueCad, tremCad, rodoCad, construCad, galeriaCad, casaAbanCad, outrosLocaisCad, moradiaCad, ameacaCad, drogasCad, familiaCad, desemCad, trabalhoCad, saudeCad, opcaoCad, nsabeCad, outroMotiCad) VALUES ('" + req.body.nomeCad + "','" + req.body.chamadoCad + "','" + req.body.docCad + "','" + req.body.rgCad + "','" + req.body.cpfCad + "','" + req.body.nascimentoCad + "','" + req.body.localCad + "','" + req.body.abrigoCad + "','" + req.body.domPartCad + "','" + req.body.ruaVezCad + "','" + req.body.albVezCad + "','" + req.body.dompartvezCad + "','" + req.body.dompartQual + "','" + req.body.viveRuaCad + "','" + req.body.moraCidaCad + "','" + req.body.viveFamCad + "','" + req.body.parenteCad + "','" + req.body.attcomCad + "','" + req.body.atendLuCad + "','" + req.body.centroCad + "','" + req.body.centrorefCad + "','" + req.body.instacolhiCad + "','" + req.body.hospiCad + "','" + req.body.trabaCad + "','" + req.body.dinheiroCad + "','" + req.body.dinheiroCad2 + "','" + req.body.dinheiroCad3 + "','" + req.body.dinheiroCad4 + "','" + req.body.dinheiroCad5 + "','" + req.body.dinheiroCad6 + "','" + req.body.dinheiroCad7 + "','" + req.body.benefCad + "','" + req.body.qualBenefCad + "','" + req.body.marqViaCad + "','" + req.body.predioCad + "','" + req.body.parqueCad + "','" + req.body.tremCad + "','" + req.body.rodoCad + "','" + req.body.construCad + "','" + req.body.galeriaCad + "','" + req.body.casaAbanCad + "','" + req.body.outrosLocaisCad + "','" + req.body.moradiaCad + "','" + req.body.ameacaCad + "','" + req.body.drogasCad + "','" + req.body.familiaCad + "','" + req.body.desemCad + "','" + req.body.trabalhoCad + "','" + req.body.saudeCad + "','" + req.body.opcaoCad + "','" + req.body.nsabeCad + "','" + req.body.outroMotiCad + "')";
  var db = new sqlite3.Database(DBPATH); // Abre o banco
  db.run(sql, [],  err => {
      if (err) {
          throw err;
